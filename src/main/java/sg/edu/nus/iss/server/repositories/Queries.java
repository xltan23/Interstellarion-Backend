...
public class Queries {
    ...
    public static final String SQL_UPDATE_DREAMER_PROFILE = "UPDATE dreamers SET first_name = ?, last_name = ?, profile_image_url = ? WHERE email = ?";
    public static final String SQL_DELETE_DREAMER = "DELETE FROM dreamers WHERE email = ?";
}
